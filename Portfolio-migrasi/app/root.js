...
export function Layout({ children }) {
    return (_jsxs("html", { lang: "en", children: [_jsxs("head", { children: [_jsx("meta", { charSet: "utf-8" }), _jsx("meta", { name: "viewport", content: "width=device-width, initial-scale=1" }), _jsx(Meta, {}), _jsx(Links, {})] }), _jsxs("body", { children: [_jsx("div", { className: "bg-grid", "aria-hidden": "true" }), _jsx("div", { className: "bg-glow-top", "aria-hidden": "true" }), _jsx(Cursor, {}), children, _jsx(ScrollRestoration, {}), _jsx(Scripts, {})] })] }));
}
...
export function ErrorBoundary({ error }) {
    ...
    return (_jsxs("div", { style: {
        ...
        }, children: [_jsx("h1", { style: { fontFamily: 'var(--font-display, sans-serif)', fontSize: '2.5rem', margin: 0 }, children: title }), _jsx("p", { style: { color: 'var(--color-text-secondary, #8A8A9A)', margin: 0 }, children: message }), _jsx("a", { href: "/", style: {
